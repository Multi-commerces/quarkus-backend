...
public final class AuthenticationData {
    ...
    public AuthenticationData(
        ...
        this.organizationTokenName = organizationTokenName != null ? organizationTokenName : "";
    }
    ...
    public User unbind(@NotNull User user, @NotNull Function<String, Optional<Organization>> findOrganization) {
        ...
        user.organization = findOrganization.apply(getOrganizationTokenName())
                .orElseThrow(() -> new RuntimeException(String.format("Organization [%s] was not found in the DB", organizationTokenName)));
