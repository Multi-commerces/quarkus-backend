...
import fr.commerces.microservices.catalog.products.lang.ProductLangDepth1Data;
...
@ApplicationScoped
@Mapper(uses = { JsonNullableMapper.class, ProductShippingMapper.class, ProductBasicMapper.class,
		ProductVariationMapper.class, ProductPricingMapper.class }, config = DefaultMappingConfig.class)
public abstract class ProductMapper {
	...
	public ProductDepth1Data toDepth1(final Product source) {
		...
		final List<CategoryData> categories = source.getCategories().stream()
				.map(o -> categoryMapper.toCategoryData(o.getCategory())).collect(Collectors.toList());
