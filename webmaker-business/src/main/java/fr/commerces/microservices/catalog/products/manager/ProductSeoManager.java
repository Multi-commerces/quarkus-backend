...
import fr.commerces.microservices.catalog.products.mapper.ProductSeoMapper;
...
public class ProductSeoManager {
	...
	public final ProductSeoData findSeoByProductLangPK(@NotNull final Long productId,
		...
		return ProductLang.findByIdProductAndLanguageCode(productId, languageCode).map(mapper::toData)
